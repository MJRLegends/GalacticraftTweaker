...
@Mod(modid = GalacticraftTweaker.MODID, name = GalacticraftTweaker.NAME, version = GalacticraftTweaker.VERSION, dependencies = "required-after:galacticraftcore@[4.0.1.181,); required-after:galacticraftplanets@[4.0.1.181,); required-after:crafttweaker@[3.0.25.,); after:extraplanets;", certificateFingerprint = "b02331787272ec3515ebe63ecdeea0d746653468")
public class GalacticraftTweaker {
	public static final String MODID = "galacticrafttweaker";
	public static final String NAME = "Galacticraft Tweaker";
